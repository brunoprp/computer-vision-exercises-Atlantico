...
# -*- coding: utf-8 -*-
"""
Created on Sun Jul 26 20:49:01 2020
...
class Detect():
    ...
    def detectImg(self, original_image, model, suppress=None):
        ...
        det_boxes, det_labels, det_scores = model.detect_objects(predicted_locs, predicted_scores, min_score= self.min_score,
    ...
    def loadModel(self, model_path):
        """Load model trained for predition"""
